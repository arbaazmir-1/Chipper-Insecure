                  ...
                  {friendRequest?.map((item) => (
                    <div className="group relative flex justify-between gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                      <div className="flex items-center">
                        <img
                          src={item.photo ? item.photo : "https://www.pngitem.com/pimgs/m/30-307416_profile-icon-png-image-free-download-searchpng-employee.png"}
                          alt=""
                          className="w-10 h-10 rounded-full m-1"
                        />
                        <p className="mt-1 text-gray-600 m-1">{item.email}</p>
                      </div>
        ...
        <Popover className="relative">
          <Popover.Button className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 outline-none">
            <img
              ...
              src={auth?.currentUser?.photoURL ? auth?.currentUser?.photoURL : "https://www.pngitem.com/pimgs/m/30-307416_profile-icon-png-image-free-download-searchpng-employee.png"}
              alt="user avatar"
            />
